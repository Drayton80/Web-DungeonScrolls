...
export default class Sheet extends Component {
  ...
  render() {
    ...
    return (
      <div key={this.state.sheetClicked.id} className='container-fluid p-0'>
        ...
        <div className="sheet-switch-pc">
          ...
          <div className='container-fluid p-0' style={{ width: "80%" }}>
                  ...
                  <div className="row align-items-end p-0">
                    ...
                    <div className="form-group col-3 pl-0 pr-2">
                      ...
                      <input type="text" name="name" className="form-control"
                        defaultValue={this.state.sheetClicked.name}
                    ...
                    <div className="form-group col-3 pl-0 pr-2">
                      ...
                      <input type="text" name="information_name" className="form-control"
                        defaultValue={this.state.sheetClicked.information_name}
                        onChange={this.handleOnChange} />
                    </div>
                    {/* Button - Save Changes */}
                  ...
                  <div className='row align-items-end p-0'>
                    ...
                    <div className="form-group col-2 pl-0 pr-2">
                      ...
                      <input type="text" name="information_experience" className="form-control" onChange={this.handleOnChange}
                        defaultValue={this.state.sheetClicked.information_experience} />
                    </div>
                    {/* Next Level XP */}
                    <div className="form-group col-2 pl-0 pr-2">
            ...
            <div className="container-fluid p-0 w-100 mt-3">
              <input type="radio" name="attr_tab" className="sheet-tab sheet-tab1 ml-4" defaultValue={1} defaultChecked="checked" />
                          ...
                          <tbody><tr><td style={{ textAlign: 'left' }}>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_strength_modifier"
                                defaultValue={this.state.sheetClicked.ability_strength_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_dexterity_modifier"
                                defaultValue={this.state.sheetClicked.ability_dexterity_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_constitution_modifier"
                                defaultValue={this.state.sheetClicked.ability_constitution_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_intelligence_modifier"
                                defaultValue={this.state.sheetClicked.ability_intelligence_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_wisdom_modifier"
                                defaultValue={this.state.sheetClicked.ability_wisdom_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <div className="sheet-table-row">
                              ...
                              <span className="sheet-table-data-center"><input type="text" style={{ width: '45px' }} name="ability_charisma_modifier"
                                defaultValue={this.state.sheetClicked.ability_charisma_modifier} onChange={this.handleOnChange} /></span>
                            ...
                            <td>
                              <table>
                                <tbody><tr>
                                  ...
                                  <td><input className="sheet-inputbox" type="text" name="battle_hp_current" defaultValue={this.state.sheetClicked.battle_hp_current} onChange={this.handleOnChange} style={{ height: '24px', width: '75px', textAlign: 'center' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="current-hit-points">Current HP</div></td>
                                  <td><input className="sheet-inputbox" type="text" name="battle_hp_total" defaultValue={this.state.sheetClicked.battle_hp_total} onChange={this.handleOnChange} style={{ height: '24px', width: '75px', textAlign: 'center' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="max">Max</div></td>
                                  <td><input className="sheet-inputbox" type="text" name="battle_hp_nonlethal" defaultValue={this.state.sheetClicked.battle_hp_nonlethal} onChange={this.handleOnChange} style={{ height: '24px', width: '75px', textAlign: 'center' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="nonlethal-damage">Nonlethal Damage</div></td>
                                </tr>
                                  <tr>
                                    ...
                                    <td colSpan={2}>
                                      <table>
                                        <tbody><tr>
                                          <td><input className="sheet-inputbox" type="text" name="battle_initiative_total" style={{ height: '24px', width: '30px' }} defaultValue={this.state.sheetClicked.battle_initiative_total} onChange={this.handleOnChange} /> =<br /><div style={{ fontSize: '0.5em' }} data-i18n="total">Total</div></td>
                                          <td><input className="sheet-inputbox" type="text" name="ability_dexterity_modifier" defaultValue={this.state.sheetClicked.ability_dexterity_modifier} onChange={this.handleOnChange} style={{ height: '24px', width: '30px' }} /> +<br /><div style={{ fontSize: '0.5em' }} data-i18n="dexterity-modifier">Dex Mod</div></td>
                                          <td><input className="sheet-inputbox" type="text" name="battle_initiative_others" defaultValue={this.state.sheetClicked.battle_initiative_others} onChange={this.handleOnChange} style={{ height: '24px', width: '30px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="miscellaneous-modifier-a">Misc Mod</div></td>
                                        </tr>
                                        </tbody></table>
                                    </td>
                                    <td>
                                ...
                                <table>
                                  <tbody><tr>
                                    ...
                                    <td><input className="sheet-inputbox" type="text" name="battle_ca_total"
                                      defaultValue={this.state.sheetClicked.battle_ca_total} onChange={this.handleOnChange} style={{ height: '24px', width: '35px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="total">Total</div></td>
                                    <td>=10<br /><br /></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="ability_dexterity_modifier"
                                      defaultValue={this.state.sheetClicked.ability_dexterity_modifier} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="ability-modifier-a">Ability Mod</div></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="battle_ca_equipment_armor"
                                      defaultValue={this.state.sheetClicked.battle_ca_equipment_armor} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="armor-bonus-a">Armor Bns</div></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="information_size_modifier_ca_and_attack"
                                      defaultValue={this.state.sheetClicked.information_size_modifier_ca_and_attack} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="size-modifier-a">Size Mod</div></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="battle_ca_natural_armor"
                                      defaultValue={this.state.sheetClicked.battle_ca_natural_armor} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="natural-armor-a">Nat. Armor</div></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="battle_ca_deflection_modifier"
                                      defaultValue={this.state.sheetClicked.battle_ca_deflection_modifier} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="deflection">Deflection</div></td>
                                    <td>+<input className="sheet-inputbox" type="text" name="battle_ca_other_modifier"
                                      defaultValue={this.state.sheetClicked.battle_ca_other_modifier} onChange={this.handleOnChange} style={{ height: '24px', width: '28px' }} /><br /><div style={{ fontSize: '0.5em' }} data-i18n="miscellaneous-modifier-a">Misc Mod</div></td>
                                    <td> &nbsp; &nbsp; &nbsp; </td>
                                  </tr>
                                  </tbody></table>
                              </td>
                              ...
                              <td colSpan={2}>
                                <table>
                                  <tbody><tr>
                                    ...
                                    <td valign="top"><input className="sheet-inputbox" type="text" style={{ height: '24px', width: '35px' }} name="battle_ca_touch" defaultValue={this.state.sheetClicked.battle_ca_touch} onChange={this.handleOnChange} /> &nbsp; </td>
                                    ...
                                    <td valign="top"><input className="sheet-inputbox" type="text" style={{ height: '24px', width: '35px' }} name="battle_ca_flat_footed" defaultValue={this.state.sheetClicked.battle_ca_flat_footed} onChange={this.handleOnChange} /> &nbsp; </td>
                                    <td valign="top"><input className="sheet-inputbox" type="text" name="battle_damage_reduction" style={{ height: '24px', width: '75px' }} defaultValue={this.state.sheetClicked.battle_damage_reduction} onChange={this.handleOnChange} /><br /><div style={{ fontSize: '0.65em' }} data-i18n="damage-reduction">Damage Reduction</div></td>
                                  </tr>
                                  </tbody></table>
                                <br />
                              </td>
                              ...
                              <td className="sheet-table-data-left">
                                ...
                                <table cellPadding={0} cellSpacing={0}>
                                  <tbody><tr><td style={{ textAlign: 'left' }}>
                                    ...
                                    <div className="sheet-table-row">
                                      ...
                                      <span className="sheet-table-data-center"><input type="text" style={{ width: '35px' }} name="saving_throws_fortitude_total" defaultValue={this.state.sheetClicked.saving_throws_fortitude_total} onChange={this.handleOnChange} /></span>
                                      ...
                                      <span className="sheet-table-data-center">+<input type="text" style={{ width: '35px' }} name="ability_constitution_modifier" defaultValue={this.state.sheetClicked.ability_constitution_modifier} onChange={this.handleOnChange} /></span>
                                    ...
                                    <div className="sheet-table-row" style={{ fontSize: '1em' }}>
                                      ...
                                      <span className="sheet-table-data-center"><input type="text" style={{ width: '35px' }} name="saving_throws_reflex_total" defaultValue={this.state.sheetClicked.saving_throws_reflex_total} onChange={this.handleOnChange} /></span>
                                      ...
                                      <span className="sheet-table-data-center">+<input type="text" style={{ width: '35px' }} name="ability_dexterity_modifier" defaultValue={this.state.sheetClicked.ability_dexterity_modifier} onChange={this.handleOnChange} /></span>
                                    ...
                                    <div className="sheet-table-row">
                                      ...
                                      <span className="sheet-table-data-center"><input type="text" style={{ width: '35px' }} name="saving_throws_will_total" defaultValue={this.state.sheetClicked.saving_throws_will_total} onChange={this.handleOnChange} /></span>
                                      ...
                                      <span className="sheet-table-data-center">+<input type="text" style={{ width: '35px' }} name="ability_wisdom_modifier" defaultValue={this.state.sheetClicked.ability_wisdom_modifier} onChange={this.handleOnChange} /></span>
                                ...
                                <table>
                                  <tbody><tr>
                                    ...
                                    <td><input className="sheet-inputbox" type="text" name="magic_arcane_spell_failure" defaultValue={this.state.sheetClicked.magic_arcane_spell_failure} onChange={this.handleOnChange} style={{ height: '24px', width: '50px' }} /></td>
                                    <div className="sheet-table-row">
                                ...
                                <table cellPadding={0} cellSpacing={0}>
                                  <tbody><tr><td style={{ textAlign: 'left' }}>
                                    ...
                                    <div className="sheet-table-row">
                                      ...
                                      <span className="sheet-table-data-center"><input className="sheet-inputbox" type="text" style={{ width: '45px' }} name="battle_grapple_total" defaultValue={this.state.sheetClicked.battle_grapple_total} onChange={this.handleOnChange} /></span>
                                    </div>
