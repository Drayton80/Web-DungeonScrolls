    ...
    return (
      <div>
        ...
        <div className="sheet-switch-pc">
          ...
          <div class='container'>
            <input type="checkbox" className="sheet-pc-charrpinfo-show sheet-arrow" name="attr_charrpinfo-show" key={this.state.sheetClicked.id} defaultValue={1} defaultChecked /><span style={{ textAlign: 'left' }} data-i18n="header">Header</span>
                            ...
                            <tbody><tr>
                              <td><div style={{ float: 'left' }}>
                                <input type="text" name="information_name" 
                                  style={{ width: '125px', textAlign: 'right' }} key={this.state.sheetClicked.id} defaultValue={this.state.sheetClicked.information_name}
                                  onChange={this.handleOnChange} />
                                <br /><span data-i18n="character-name">Character Name</span></div></td>
                                
                               <td><div style={{ float: 'left' }}>
                                <input type="text" name="name" 
                                  style={{ width: '125px', textAlign: 'right' }} key={this.state.sheetClicked.id} defaultValue={this.state.sheetClicked.name}
                                  onChange={this.handleOnChange} />
          ...
          <input type="radio" name="attr_tab" className="sheet-tab sheet-tab1" key={this.state.sheetClicked.id} defaultValue={1} defaultChecked="checked" />
